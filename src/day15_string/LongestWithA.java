...
public class LongestWithA {
    public static void main(String[] args) {
        ...
        //  HINT: nested if
        if (isFirstLongestWithA || isSecondLongestWithA || isThirdLongestWithA) {
            ...
            // None of the words contain 'a'
            System.out.println("None of the words contain the character 'a'.");
        }
